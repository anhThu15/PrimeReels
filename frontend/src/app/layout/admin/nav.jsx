        ...
        <div className="col-md-2 p-0 collapse collapse-horizontal show" style={{minHeight: "100vh", backgroundColor: "#213436"}} id="moMenu">
          <strong className="text-center d-block p-3" style={{color: "white"}}> 
           ...
           <div className="list-group list-group-flush">
            ...
            <Link style={{backgroundColor:"#213436"}} href="/admin/voucherType" className={`list-group-item list-group-item-action text-white ${pathName == '/admin/voucherType' ? "text-bg-dark":"" }`}><img src="/images/vch.png" alt="" /><span> Thể Loại Voucher</span></Link>
