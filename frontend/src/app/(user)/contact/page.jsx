                    ...
                    <div class="row pt-5">
                      <div class="col-3">
                        <div class="list-group" id="list-tab" role="tablist">
                          <a class=" text-start ms-2 ps-3 active btn btn-outline-light" id="list-home-list" data-bs-toggle="list" href="#list-home" role="tab" aria-controls="list-home">
                                <p className="fs-6 mt-2"> <i class="fa-solid fa-headphones"></i> Yêu cầu hỗ trợ </p>
                          </a>
                          <a class=" text-start ms-2 ps-3 btn btn-outline-light mt-3" id="list-profile-list" data-bs-toggle="list" href="#list-profile" role="tab" aria-controls="list-profile">
                                <p className="fs-6 mt-2"> <i class="fa-solid fa-message"></i> Hỏi Đáp </p>
                          </a>
                        </div>
                      </div>
                      <div class="col-8">
                        <div class="tab-content" id="nav-tabContent">
                          <div class="tab-pane fade show active bg-light text-black fs-1" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                                    Liên Hệ:
                                    <br />
                          ...
                          <div class="tab-pane fade bg-light text-black" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">                                   
