        ...
        <div className=" row-cols-3 row">
          ...
          <div class="card text-bg-dark hover-box me-5" style={{width:"450px", marginRight:"7.9px"}}>
              <div className="bg-black opacity-75">
                  <img src="https://static.bandainamcoent.eu/high/spyxfamily/spyxanya-operation-memories/01-news/movie-crunchyroll-collab/spyxfamily-movie-thumbnail.jpg" height={220} class="card-img" alt="..."/>
              </div>
