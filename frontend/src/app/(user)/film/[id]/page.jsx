    ...
    <>
      <div className="container-fluid bg-black p-0 text-white">
        ...
        <div className="row container p-0 row-cols-3" style={{ marginLeft: "90px" }}  >
          <div className="col-auto fw-bold mb-3"><p className="text-secondary">Quốc Gia:</p> {film.country}</div>
          <div className="col-auto fw-bold mb-3"><p className="text-secondary">Đạo Diễn:</p> {film.director}</div>
          <div className="col-auto fw-bold mb-3">
            <p className="text-secondary">Diễn Viên:</p>
            <div className="row">
              {film?.actors?.map((actor) => {
                return (
                  <>
                    <div key={actor.actor_id} className="col-auto">{actor.name}</div>
                  </>
                )
              })}
          ...
          <div className=" col-auto d-flex flex-wrap mt-4">
            {film?.actors?.map((actor) => {
              return (
                <>
