...
export default function FilterOddFilm() {
    ...
    const fetchMovies = (genreId) => {
        if (genreId) {
            ...
            fetch(`${process.env.NEXT_PUBLIC_API_URL}/movies-genre/${genreId}`)
                ...
                .then((data) => {
                    const filteredMovies = data.filter(movie => movie.movie_type_id === 2);
                ...
                <div className="container">
                    ...
                    <div className="product-slider mt-3">
                        {movies.length > 0 ? (
                            ...
                            !loading && <div class="alert alert-danger" role="alert">
