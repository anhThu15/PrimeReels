                ...
                <div className="row">
                    <div className="col-md-8">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control rounded" id="actorName" placeholder="Nhập tên người dùng" />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="actorBio" className="form-label">Email</label>
                            <input type="text" className="form-control rounded" id="actorName" placeholder="Nhập email đăng nhập" />
                        </div>
                        <div className="mb-3">
                            <div className="row">
                                <div className="col-md-6">
                                    <label htmlFor="actorBio" className="form-label">Mật khẩu</label>
                                    <input type="text" className="form-control rounded" id="actorName" placeholder="Nhập mật khẩu đăng nhập" />
                                </div>
                                <div className="col-md-6">
                    ...
                    <div className="col-md-4">
                        ...
                        <div className="text-center">
                            <img src="../../images/default-user.png" alt="Avatar" style={{ width: "250px", objectFit: "cover", height: "250px" }} className="rounded-circle mb-3" />
                            <div>
