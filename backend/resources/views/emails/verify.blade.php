                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:250px;">
                                                                <a href="https://www.facebook.com/HuynhNgocTaidz"
                                                                    target="_blank">
                                                                    <img alt="" title="Huỳnh Ngọc Tài"
                                                                        height="38px"
                                                                        src="https://i.imgur.com/ljhnFot.png"
                                            ...
                                            <tr>
                                                <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;"
                                                    ...
                                                    <div
                                                        ...
                                                        <p><img src="https://i.imgur.com/4MjONhe.png"
...
<body>
    <h1>Chào {{ $user->user_name }}</h1>
    <p>Vui lòng nhấp vào liên kết bên dưới để xác minh email của bạn:</p>
    <a href="{{ url('api/verify-email/' . $userId . '/' . $token) }}">Xác minh Email</a>
</body>
</html> --}}
