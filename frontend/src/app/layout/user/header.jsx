...
export default function HeaderUser(){
  ...
  const theloaiphim = `<div class="d-flex flex-wrap">
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                      <button class="nav-link custom-tooltip" data-bs-toggle="tooltip" data-bs-placement="bottom" 
                    ...
                    <li class="nav-item">
                      <button class="nav-link custom-tooltip" data-bs-toggle="tooltip" data-bs-placement="bottom" 
                        data-bs-html="true" data-bs-original-title={theloaiphim}>
                          THÊ LOẠI PHIM <i class="fa-solid fa-caret-down" style={{color: "#bfe661"}}></i>
                      </button>
                    </li>
                    <li class="nav-item">
